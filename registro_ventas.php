                        ...
                        <div class="d-flex justify-content-center align-items-center ">
                            <form action="php\procesos.php" method="post" class="p-4 border">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="monto" class="form-control" pattern="^\d+(\.\d{1,2})?$" title="Ingrese un monto válido (hasta dos decimales)" required>
                                </div>
                            ...
                            <div class="modal" tabindex="-1" role="dialog" id="errorModal">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Error al registrar. <!-- Puedes mostrar detalles del error aquí si lo deseas. --></p>
                                        </div>
                                        <div class="modal-footer">
